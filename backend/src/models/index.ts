...
User.hasMany(ContentPage, { foreignKey: "authorId", as: "contentPages" });
ContentPage.belongsTo(User, { foreignKey: "authorId", as: "author" });
ContentPage.hasMany(Comment, { foreignKey: "pageId", as: "comments" });
Comment.belongsTo(ContentPage, { foreignKey: "pageId", as: "page" });
...
CatalogItem.belongsTo(Media, { foreignKey: "imageMediaId", as: "imageMedia" });
Media.hasMany(CatalogItem, { foreignKey: "imageMediaId", as: "catalogItems" });
